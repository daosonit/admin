...
<div class="row">
    <div class="col-md-12">
    	<div class="box box-info">
            {!! Form::open(['name' => 'room', 'method' => 'POST', 'class' => '']) !!}
            @if (count($errors) > 0)
            ...
            <div class="box-header">
                <h3 class="box-title">Tạo loại phòng</h3>
            </div>
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="box-body content-box">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    {!! Form::text('room_total', '', ['class' => 'form-control']) !!}
                                </div>
                            </div>
                            <br/>
                            <div class="form-group">
                                ...
                                <div class="col-sm-2 input-group">
                                    {!! Form::text('room_area', '', ['class' => 'form-control']) !!}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    {!! Form::text('adult', '', ['class' => 'form-control']) !!}
                                </div>
                            </div>
                            <br/>
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    {!! Form::text('child', '', ['class' => 'form-control']) !!}
                                </div>
                            </div>
                            <br/>
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <label>
                                        {!! Form::radio('room_smoke', '1', true, ['class' => 'minimal-red']) !!}
                                    </label>
                                    <label class="r2">Có</label>
                                    <label>
                                        {!! Form::radio('room_smoke', '0', false, ['class' => 'minimal-red']) !!}
                                    </label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="box-body content-box">
                            <div class="form-group">
                                ...
                                <div class="col-sm-1">
                                    {!! Form::input('number','bed[single-bed]', '0', ['class' => 'form-control bfh-number']) !!}
                                </div>
                            </div>
                            <br/>
                            <div class="form-group">
                                ...
                                <div class="col-sm-1">
                                    {!! Form::input('number','bed[double-bed]', '0', ['class' => 'form-control bfh-number']) !!}
                                </div>
                            </div>
                            <br/>
                            <div class="form-group">
                                ...
                                <div class="col-sm-1">
                                    {!! Form::input('number','bed[queen-bed]', '0', ['class' => 'form-control bfh-number']) !!}
                                </div>
                            </div>
                            <br/>
                            <div class="form-group">
                                ...
                                <div class="col-sm-1">
                                    {!! Form::input('number','bed[king-bed]', '0', ['class' => 'form-control bfh-number']) !!}
                                </div>
                            </div>
                            <br/>
                            <div class="form-group">
                                ...
                                <div class="col-sm-1">
                                    {!! Form::input('number','bed[division-bed]', '0', ['class' => 'form-control bfh-number']) !!}
                                </div>
                            </div>
                            <br/>
                            <div class="form-group">
                                ...
                                <div class="col-sm-1">
                                    {!! Form::input('number','bed[sofa-bed]', '0', ['class' => 'form-control bfh-number']) !!}
                                </div>
                            </div>
                            <br/>
                        ...
                        <div class="box-body content-box box-ex-bed" style="display: none;">
                            <div class="form-group">
                                ...
                                <div class="col-sm-1">
                                    <input type="number" class="form-control bfh-number" name="ex-single-bed" value="0">
                                </div>
                            </div>
                            <br/>
                            <div class="form-group">
                                ...
                                <div class="col-sm-1">
                                    <input type="number" class="form-control bfh-number" name="ex-double-bed" value="0">
                                </div>
                            </div>
                            <br/>
                            <div class="form-group">
                                ...
                                <div class="col-sm-1">
                                    <input type="number" class="form-control bfh-number" name="ex-queen-bed" value="0">
                                </div>
                            </div>
                            <br/>
                            <div class="form-group">
                                ...
                                <div class="col-sm-1">
                                    <input type="number" class="form-control bfh-number" name="ex-king-bed" value="0">
                                </div>
                            </div>
                            <br/>
                            <div class="form-group">
                                ...
                                <div class="col-sm-1">
                                    <input type="number" class="form-control bfh-number" name="ex-division-bed" value="0">
                                </div>
                            </div>
                            <br/>
                            <div class="form-group">
                                ...
                                <div class="col-sm-1">
                                    <input type="number" class="form-control bfh-number" name="ex-sofa-bed" value="0">
                                </div>
                            </div>
                        ...
                        <div class="box-body content-box">
                            ...
                            @foreach ($data_conveniences as $value)
                                <label class="conv col-sm-3">
                                    <input type="checkbox" class="flat-red control-label" name="convenience[]" value="{{ $value->con_id }}">
                                    {{ $value->con_name }}
                                </label>
                                <!-- <label class="conv">
                            ...
                            <div class="form-group">
                                <div>
                                    <label class="conv col-sm-2">
                                        <input type="radio" name="trend" class="minimal-red" checked value="1">
                                        Hướng biển</label>
                                    <label class="conv col-sm-2">
                                        <input type="radio" name="trend" class="minimal-red" value="2">
                                        Sát biển</label>
                                    <label class="conv col-sm-2">
                                        <input type="radio" name="trend" class="minimal-red" value="3">
                                        Hường phố</label>
                                </div>
                                <div style="clear: both; margin-bottom:10px;"></div>
                                <div>
                                    <label class="conv col-sm-2">
                                        <input type="radio" name="trend" class="minimal-red" value="4">
                                        Hướng vườn</label>
                                    <label class="conv col-sm-2">
                                        <input type="radio" name="trend" class="minimal-red" value="5">
                                        Hướng hồ bơi</label>
                                    <label class="conv" style="margin-left: 30px;">
                                        <input type="radio" name="trend" class="minimal-red" value="6">
                                        Hướng 1 phần (nghĩa là không hoàn toàn)</label>
                                </div>
                                <div style="clear: both; margin-bottom:10px;"></div>
                                <div>
                                    <label class="conv col-sm-2">
                                        <input type="radio" name="trend" class="minimal-red" value="0">
                                        Không có</label>
                                </div>
                            </div>
                        </div>
